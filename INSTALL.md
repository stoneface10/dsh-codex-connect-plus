...
2. Install the public npm beta:
   ...
   For a reproducible fallback, use the immutable `v0.1.0-beta.3` GitHub tag or download the matching prerelease `.tgz` and verify its published SHA-256 before installation.
